...
module.exports = {
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1416210808657641',
    clientSecret: process.env.FACEBOOK_SECRET || 'c35119a972e3dfedbe9fd413413061ba',
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '824964475090-6m67ecv839ms328iodf52v1r72nc3kll.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'Fpaiv44wWJGAMYyPj8QqZpcc',
